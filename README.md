...
RussianDex is a bot for collecting countryballs on Discord and exchange them with your friends!

You can invite the bot [here](https://discord.com/api/oauth2/authorize?client_id=1073275888466145370&permissions=8&scope=bot)
...
If distributing this bot, credits to the original author El Laggron must not be removed.

Please note that if you utilize any code from my GitHub repository (such as the 'spawnalert' function), 
you are legally obligated to provide proper attribution to me, GamingadlerHD, as the original author. 
It is strictly prohibited to claim ownership of the code I have written as your own. 
It is imperative that you honestly acknowledge the authorship of the code and clearly state that I, 
GamingadlerHD, am the original creator of this code part.
